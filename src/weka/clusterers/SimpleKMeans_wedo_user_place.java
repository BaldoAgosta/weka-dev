 ...
 */
public class SimpleKMeans_wedo_user_place 
  ...
  /**
	 * 
	 */
	private static final long serialVersionUID = -6083018584403310100L;
...
/** for serialization */
 // static final long serialVersionUID = -3235809600124455376L;
  ...
  protected DistanceFunction m_DistanceFunction = new ManhattanDistance_wedo_user_place();
   ...
   */
  public SimpleKMeans_wedo_user_place() {
    super();
  ...
  protected double[] moveCentroid(int centroidIndex, Instances members, boolean updateClusterInfo){
    ...
    if(m_DistanceFunction instanceof ManhattanDistance || m_DistanceFunction instanceof ManhattanDistance_wedo_user_place){
    ...
    for (int j = 0; j < members.numAttributes(); j++) {						
      ...
      if(m_DistanceFunction instanceof EuclideanDistance ||
        ...
        }else if(m_DistanceFunction instanceof ManhattanDistance || m_DistanceFunction instanceof ManhattanDistance_wedo_user_place){
  ...
  public void setDistanceFunction(DistanceFunction df) throws Exception {
    if(!(df instanceof EuclideanDistance) && 
       ...
       && !(df instanceof ManhattanDistance_wedo_user_place)
    		)
      {
  ...
  public static void main (String[] argv) {
    runClusterer(new SimpleKMeans_wedo_user_place(), argv);
  }
}
