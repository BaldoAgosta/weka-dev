 ...
 */
public class EM_wedo_event_doc
 ...
 /** globally replace missing values */
  ...
  private void EM_Init (Instances inst)
    ...
    // change in only 5 times for improve performance
    SimpleKMeans_wedo_event_doc bestK = null;
    SimpleKMeans_wedo_event_doc bestKAVG = null;
    ManhattanDistance_wedo_event_doc df = new ManhattanDistance_wedo_event_doc();
    ...
    for (i = 0; i < 5; i++) {
      SimpleKMeans_wedo_event_doc sk = new SimpleKMeans_wedo_event_doc();
  ...
  */
  ...
  public static void main (String[] argv) {
    runClusterer(new EM_wedo_event_doc(), argv);
  }
}
