...
import weka.core.ManhattanDistance_wedo_user_doc;
import weka.core.ManhattanDistance_wedo_user_place;
 ...
 */
public class EM_wedo_user_place
  ...
  /**
	 * 
	 */
	private static final long serialVersionUID = -5879365238305908267L;
...
/** for serialization */
 ...
 /** globally replace missing values */
  ...
  private void EM_Init (Instances inst)
    ...
    SimpleKMeans_wedo_user_place bestK = null;
    SimpleKMeans_wedo_user_place bestKAVG = null;
    ManhattanDistance_wedo_user_place df = new ManhattanDistance_wedo_user_place();
    double bestSqE = Double.MAX_VALUE;
    double bestSqE_LOWER = Double.MAX_VALUE;
    boolean go = true;
    ...
    for (i = 0; i < 5; i++) {
      SimpleKMeans_wedo_user_place sk = new SimpleKMeans_wedo_user_place();
      sk.setDistanceFunction(df);
    ...
    if(bestSqE < bestSqE_LOWER)
    { bestSqE_LOWER = bestSqE; bestKAVG = bestK;m_num_clusters++;}
    else
    go = false;
        
    }
    // initialize with best k-means solution
    m_num_clusters = bestKAVG.numberOfClusters();
    ...
    Instances centers = bestKAVG.getClusterCentroids();
    Instances stdD = bestKAVG.getClusterStandardDevs();
    int [][][] nominalCounts = bestKAVG.getClusterNominalCounts();
    int [] clusterSizes = bestKAVG.getClusterSizes();
  ...
  */
  ...
  public static void main (String[] argv) {
    runClusterer(new EM_wedo_user_place(), argv);
  }
}
