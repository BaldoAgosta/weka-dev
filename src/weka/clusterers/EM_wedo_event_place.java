...
import weka.core.ManhattanDistance_wedo_event_doc;
import weka.core.ManhattanDistance_wedo_event_place;
 ...
 */
public class EM_wedo_event_place
 ...
 /** globally replace missing values */
  ...
  private void EM_Init (Instances inst)
    ...
    // change in 5 times for improve performance
    SimpleKMeans_wedo_event_place bestK = null;
    SimpleKMeans_wedo_event_place bestKAVG = null;
    ManhattanDistance_wedo_event_place df = new ManhattanDistance_wedo_event_place();
    ...
    while(go)
    {
      ...
      SimpleKMeans_wedo_event_place sk = new SimpleKMeans_wedo_event_place();
  ...
  */
  ...
  public static void main (String[] argv) {
    runClusterer(new EM_wedo_event_place(), argv);
  }
}
