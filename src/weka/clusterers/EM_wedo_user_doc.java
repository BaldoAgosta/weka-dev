...
public class EM_wedo_user_doc
 ...
 /** globally replace missing values */
  ...
  private void EM_Init (Instances inst)
    ...
    // change in 5 for improve performance
    SimpleKMeans_wedo_user_doc bestK = null;
    SimpleKMeans_wedo_user_doc bestKAVG = null;
    ...
    for (i = 0; i < 5; i++) {
      ...
      SimpleKMeans_wedo_user_doc sk = new SimpleKMeans_wedo_user_doc();
      sk.setDistanceFunction(new ManhattanDistance_wedo_user_doc());
  ...
  */
  ...
  public static void main (String[] argv) {
    runClusterer(new EM_wedo_user_doc(), argv);
  }
}
